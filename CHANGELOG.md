...
<a name="0.5.0"></a>
## [0.5.0](https://github.com/hadenlabs/pre-commit-hooks/compare/0.4.0...0.5.0)

> 2025-08-25

### ✨ Features

* implement block files ([#85](https://github.com/hadenlabs/pre-commit-hooks/issues/85))

### 🎨 Code Refactoring

* implement standard code ([#85](https://github.com/hadenlabs/pre-commit-hooks/issues/85))

### 🐛 Bug Fixes

* disabled prepare-commit msg ([#85](https://github.com/hadenlabs/pre-commit-hooks/issues/85))
